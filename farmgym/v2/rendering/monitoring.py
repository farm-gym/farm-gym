...
class MonitorTensorBoard:
    def __init__(self, farm, list_of_variables_to_monitor, logdir="logs", run_name=None, matview=True, wait_for_exit=True):
        """
        :param farm:
    ...
    def stop(self):
        if not self.writer_closed:
            ...
            check_close = ""
            while check_close.lower() != "exit" and self.wait_for_exit is True:
