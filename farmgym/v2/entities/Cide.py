...
class Cide(Entity_API):
    ...
    def get_parameter_keys(self):
        return ['weeds','pollinators','pests','soil','base_absorption_speed#kg.week-1','bag#kg']
    ...
    def release(self, position):
        amount = min(self.parameters['base_absorption_speed#kg.week-1']/7., self.variables['amount#kg'][position].value)
