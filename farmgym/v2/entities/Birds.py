...
class Birds(Entity_API):
    def __init__(self,field,parameters):
        ...
        self.variables = {}
        self.variables["population#nb"] =  Range((0,100000),0.)
        self.variables["total_cumulated_birds#nb"] =  Range((0,1000000),0.)
    ...
    def reset(self):
        ...
        if ('population#nb' not in self.initial_conditions):
            self.variables["population#nb"].set_value(0.)
    ...
    def update_variables(self,field,entities):
        ...
        self.variables["population#nb"].set_value(max(self.np_random.randint(0,self.parameters['max_population'])-strength_scarecrow,0))


        self.variables["total_cumulated_birds#nb"].set_value(self.variables["total_cumulated_birds#nb"].value+self.variables["population#nb"].value)
