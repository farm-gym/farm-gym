...
if __name__ == "__main__":
    ...
    def make_policy():
        ...
        trigger_bloom = [[(("Field-0", "Plant-0", "stage", [(0, 0)]), lambda x: x, "==", "entered_grow")]]
        action_schedule3 = [('BasicFarmer-0', 'Field-0', 'Soil-0', 'water_discrete',
